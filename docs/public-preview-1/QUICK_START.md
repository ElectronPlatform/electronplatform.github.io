...
Follow the instructions supplied with your Preview package. A final public,
signed and notarized installer is not yet claimed by this repository.

Do not bypass an operating-system security warning unless you have confirmed
the package source and integrity.
...
![Device connection status](../../images/screenshots/device-connection-status.webp)
...
![Card Lab ready for a first scan](../../images/screenshots/card-lab-first-scan.webp)
